          ...
          >
            <div className="px-6 py-6 space-y-4">
              ...
              <div className="pt-4 border-t border-border flex justify-center w-full">
                <WalletLoginButton
                  redirectOnAuth
                  className="w-full bg-primary text-primary-foreground px-[18px] py-[15px] rounded-full text-base font-semibold hover:bg-primary/90 transition-all duration-200 inline-block text-center"
                >
                  <span>Build Your Credit</span>
                </WalletLoginButton>
              </div>
            </div>
          </motion.div>
